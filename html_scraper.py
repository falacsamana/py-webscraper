...
def get_product_price(soup):
    ...
    price_spans = main_price_span.find('span')
...
def get_product_rating(soup):
    ...
    product_ratings_section = product_ratings_div.find(
        'i', attrs={'class' : 'a-icon-star'})
    product_ratings_span = product_ratings_section.find('span', attrs={
        'class': 'a-icon-alt'
    })

    try:
        rating = product_ratings_span.text.strip().split()
